              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="grid gap-1.5">
                  ...
                  <select id="spend" name="spend" className={inputClass} defaultValue="">
                    ...
                    <option value="under-20k">$400–$600</option>
                    <option value="20k-50k">$700–$800</option>
                    <option value="50k-200k">$900–$1,000</option>
                    <option value="200k-plus">$1,100–$10,000+</option>
                  </select>
                </div>
              </div>
